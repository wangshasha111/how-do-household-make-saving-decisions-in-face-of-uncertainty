...
%2.2
tic;
[V,IG,S,C] = vfi_01_infty(k,a,ap9,bbeta,r,u,d,tol,maxiter,Vinit,0);
...
varYY = zeros(T+1,1);
for tt = 1:T+1
    covConsYtt = nancov(CS_sim1(:,tt),shocks_sim1(:,tt));
    covsCY(tt) = covConsYtt(1,2);
    varYY(tt) = covConsYtt(2,2);
end
